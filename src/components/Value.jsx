...
const values = [
  {
    title: "EXCELLENCE",
    description:
      "Striving for the highest quality in every project, ensuring clean code and optimal performance.",
    icon: "✨",
  },
  {
    title: "INNOVATION",
  ...
  },
  {
    title: "COLLABORATION",
    description:
      "Working effectively with teams to create impactful solutions through shared knowledge.",
    icon: "🤝",
  },
  {
    title: "GROWTH",
    description:
      "Continuously learning and improving to stay at the forefront of technology.",
    icon: "📈",
  },
];
